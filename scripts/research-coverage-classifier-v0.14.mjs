...
const claimRegistry = readJson(
  "docs/kaigo-ops/research/claims/claims-v0.8.json",
);
...
console.log(
  JSON.stringify(
    {
      classifier_version: "0.14",
      coverage_gap: evaluate(coverage.cases),
      false_answer_stress: evaluate(stress.cases),
      external_qa_query_sample: evaluatePromotion(external.cases),
