...
const claimRegistry = readJson(
  "docs/kaigo-ops/research/claims/claims-v0.13.json",
);
...
const external = readJson(
  "docs/kaigo-ops/research/issues/information-search/benchmark/external-qa-query-sample-v0.5.json",
);
const municipal = readJson(
  "docs/kaigo-ops/research/issues/information-search/benchmark/municipal-query-sample-v0.4.json",
);
...
function isLocalAuthoritySpecific(query) {
  return (
    ...
    /(指定申請|新規指定|申請様式|締切|事前相談|申請先|窓口|移転|専用区画|用途変更|内法|新規指定前研修|管理者.{0,8}研修)/.test(
      query,
    )
  );
}
