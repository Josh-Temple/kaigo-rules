...
const claimRegistry = readJson(
  "docs/kaigo-ops/research/claims/claims-v0.17.json",
);
...
const external = readJson(
  "docs/kaigo-ops/research/issues/information-search/benchmark/external-qa-query-sample-v0.7.json",
);
const municipal = readJson(
  "docs/kaigo-ops/research/issues/information-search/benchmark/municipal-query-sample-v0.5.json",
);
...
console.log(
  JSON.stringify(
    {
      classifier_version: "0.25",
      harness: {
        municipal_sample: "municipal-query-sample-v0.5.json",
        external_sample: "external-qa-query-sample-v0.7.json",
