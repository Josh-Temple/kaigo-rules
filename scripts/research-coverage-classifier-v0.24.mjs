...
const claimRegistry = readJson(
  "docs/kaigo-ops/research/claims/claims-v0.16.json",
);
...
const external = readJson(
  "docs/kaigo-ops/research/issues/information-search/benchmark/external-qa-query-sample-v0.6.json",
);
...
console.log(
  JSON.stringify(
    {
      classifier_version: "0.24",
      harness: {
        municipal_sample: "municipal-query-sample-v0.5.json",
        external_sample: "external-qa-query-sample-v0.6.json",
