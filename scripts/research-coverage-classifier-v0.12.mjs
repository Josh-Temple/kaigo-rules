...
const claimRegistry = readJson(
  "docs/kaigo-ops/research/claims/claims-v0.7.json",
);
...
const external = readJson(
  "docs/kaigo-ops/research/issues/information-search/benchmark/external-qa-query-sample-v0.3.json",
);
