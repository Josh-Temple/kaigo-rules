...
MANIFEST_PATH = ROOT / "data" / "notice-personnel-source-manifest.json"
...
def main() -> None:
    ...
    result = {
        "format_version": 1,
        "generator": "scripts/import_notice_personnel_snapshots.py",
    ...
    print(f"Wrote {output_path.relative_to(ROOT)}: {len(segment_records)} personnel source segments")
