...
const claimRegistry = readJson(
  "docs/kaigo-ops/research/claims/claims-v0.10.json",
);
...
const municipal = readJson(
  "docs/kaigo-ops/research/issues/information-search/benchmark/municipal-query-sample-v0.2.json",
);
...
function explicitCompositionMatches(query, routedIssues) {
  ...
  return compositionRegistry.compositions
    .filter((composition) => issueIds.has(composition.issue_id))
