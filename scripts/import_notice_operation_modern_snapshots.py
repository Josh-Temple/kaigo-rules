...
MANIFEST_PATH = ROOT / "data" / "notice-operation-modern-source-manifest.json"
...
def main() -> None:
    ...
    result = {
        "format_version": 1,
        "generator": "scripts/import_notice_operation_modern_snapshots.py",
    ...
    print(f"Wrote {output_path.relative_to(ROOT)}: {len(segment_records)} operation-modern source segments")
