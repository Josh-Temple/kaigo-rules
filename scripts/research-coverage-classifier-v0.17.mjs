...
const claimRegistry = readJson(
  "docs/kaigo-ops/research/claims/claims-v0.11.json",
);
...
const municipal = readJson(
  "docs/kaigo-ops/research/issues/information-search/benchmark/municipal-query-sample-v0.3.json",
);
