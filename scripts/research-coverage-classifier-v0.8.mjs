  ...
  JSON.stringify(
    {
      ...
      note:
        "External Q&A answer text is not used. Only the public question preview is used to stress current coverage boundaries. Claim routing metadata is authoritative where present; all current ANSWER claims have explicit routing metadata in claims-v0.5. Safe synonym expansion reduced verified-regression Issue fallback to 8/51; remaining fallback is intentionally retained for multi-claim or claim-gap cases.",
    },
    null,
    2,
  ),
